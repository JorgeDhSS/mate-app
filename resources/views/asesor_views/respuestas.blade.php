			...
			<div class="modal-content py-4 text-left px-6">
				...
				<div class="my-5 mr-5 ml-5 flex justify-center">
                    <form  method="POST" id="add_caretaker_form"  class="w-full">
                        <div class="">
                            ...
                            <div class="">
                                <input type="text" id="respuestaEscribe" autocomplete="off" name="resp" class="h-3 p-6 w-full border-2 border-gray-300 mb-5 rounded-md" placeholder="Escribe aquí">
                            </div>
                            <div>
				...
				<div class="flex justify-end pt-2 space-x-14">
					...
					<button id="respuestaboton"
						class="px-4 bg-blue-500 p-3 ml-3 rounded-lg text-white hover:bg-teal-400" onclick="">Confirm</button>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="border border-blue-500 shadow-lg modal-container bg-white w-4/12 md:max-w-11/12 mx-auto rounded-xl shadow-lg z-50 overflow-y-auto">
			<div class="modal-content py-4 text-left px-6">
				...
				<div class="my-5 mr-5 ml-5 flex justify-center">
                    <form  method="POST" id="add_caretaker_form"  class="w-full">
                        <div class="">
                            ...
                            <div class="">
                                <input type="text" id="PreguntaEscribe" autocomplete="off" name="preguntas" class="h-3 p-6 w-full border-2 border-gray-300 mb-5 rounded-md" placeholder="Escribe Aquí">
                            </div>
				...
				<div class="flex justify-end pt-2 space-x-14">
					...
					<button
						class="px-4 bg-blue-500 p-3 ml-3 rounded-lg text-white hover:bg-teal-400" id="preguntaN">Confirm</button>
				</div>
			</div>
		</div>
	</div>
